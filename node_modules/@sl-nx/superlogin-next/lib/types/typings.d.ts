...
export interface CouchDbAuthDoc extends IdentifiedDocument, MaybeRevisionedDocument, IdentifiedObj {
    user_uid: string;
    user_id: string;
    password?: string;
    expires: number;
...
export declare type UserAction = 'email-verified' | 'signup' | 'create-social' | 'link-social' | 'login' | 'password-reset' | 'password-change' | 'forgot-password' | 'email-changed' | 'logout' | 'logout-all' | 'refresh' | 'consents';
/** possible events that are emmitted */
export declare type UserEvent = UserAction | 'signup-attempt' | 'forgot-password-attempt' | 'forgot-username-attempt' | 'email-change-attempt' | 'user-db-added' | 'user-deleted';
...
export declare type SlAction = (a: SlUserDoc, b: string) => Promise<SlUserDoc>;
